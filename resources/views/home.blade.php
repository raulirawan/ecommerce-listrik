                                    ...
                                    @forelse (App\Produk::all() as $item)
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-name"><a href="#">{{ $item->nama_produk }}</a></h3>
                                                <h4 class="product-price">Rp.{{ number_format($item->harga) }}</h4>

                                                <div class="product-btns">
                                                    {{-- <button class=""
                                                        onclick="window.open('{{ $item->shopee }}','_blank')"
                                                        type="button"><i class="fa shopee"></i><span class="tooltipp">Link
                                                            Shopee</span>
                                                    </button>
                                                    <button class=""
                                                        onclick="window.open('{{ $item->tokopedia }}','_blank')"
                                                        type="button"><i class="fa tokopedia"></i><span
                                                            class="tooltipp">Link Tokopedia</span>
                                                    </button> --}}
                                                    <button class=""
                                                        onclick="window.open('{{ route('detail.produk', $item->slug) }}','_blank')"
                                                        type="button"><i class="fa fa-eye"></i><span
                                                            class="tooltipp">Detail Produk</span>
                                                    </button>
                                                </div>
                                            </div>
